    ...
    <div className="max-w-4xl mx-auto">
      ...
      >
        ...
        <p className="section-subheading">
          ...
          I specialize in full‑stack web development,problem solving, AI(models),  UI/UX , with hands-on experience in technologies like React, Node.js, MongoDB, and more.
        </p>
      </motion.div>
